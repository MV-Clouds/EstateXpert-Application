...
export default class NewPopUp extends LightningElement {
    ...
    updateFields() {
        const commonFields = [
            ...
            { id: 3, fieldName: 'Notification Email', fieldAPIName: 'notification_email', datatype: 'email', value: '', isRequired: false, placeHolder: 'email@me.com', helpText: 'Email address to receive error notifications.', isFirst: false, isPicklist: false }
        ];

        if (this.getPortalName === 'Zoopla') {
            this.fields = [
                ...commonFields,
                { id: 4, fieldName: 'Branch Reference', fieldAPIName: 'branch_reference', datatype: 'text', value: '', isRequired: true, placeHolder: '"1234";"kd-789d"', helpText: 'Your unique identifier for the branch.', isFirst: false, isPicklist: false },
                { id: 5, fieldName: 'Branch Name', fieldAPIName: 'branch_name', datatype: 'text', value: '', isRequired: true, placeHolder: '"Estate Agent Ltd - Shepherd Bush"', helpText: 'The name of the branch. This is usually the name of the company and may also include some location information in order to differentiate it from the other branches of the company.', isFirst: false, isPicklist: false },
            ...
            this.fields = [
                ...commonFields,
                { id: 4, fieldName: 'Force Site URL', fieldAPIName: 'force_site_url', datatype: 'text', value: '', isRequired: true, placeHolder: 'https://my-salesforce-domain-name.my.salesforce-sites.com/', helpText: 'The URL of your Force.com site.', isFirst: false, isPicklist: false },
                { id: 5, fieldName: 'Include External Images', fieldAPIName: 'include_external_iamges', datatype: 'text', value: '', isRequired: false, placeHolder: 'true', helpText: 'When set to true all images that are external links with the category value Images will be included for all listings published on this portal', isFirst: false, isPicklist: false }
            ];
        }
    }
